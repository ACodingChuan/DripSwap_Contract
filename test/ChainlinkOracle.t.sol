...
contract ChainlinkOracleTest is Test {
    ...
    function test_getUSDPrice_Fixed() view external {
    ...
    function test_getUSDPrice_UsesAggregatorDecimals_WhenCacheIsZero() view external {
    ...
    function test_getUSDPrice_UsesCachedDecimals_WhenNonZero() view external {
    ...
    function test_getUSDPrice_DecimalsLessThan18_MulPath() view external {
    ...
    function test_latestAnswer_BothFixed() external {
        ...
        // (2 / 1) * 1e18 = 2e18
        assertEq(price, 2e18);
        assertEq(uint(src), uint(IOracleRouter.PriceSrc.Fixed));
        assertEq(ts, block.timestamp); // 双 Fixed：返回当前块时间
    }

    function test_latestAnswer_BaseFixed_QuoteUsd()  view external {
    ...
    function test_latestAnswer_QuoteFixed_BaseUsd() view external {
    ...
    function test_latestAnswer_UsdSplit_BothFromFeeds_MinTimestamp() view external {
        ...
        assertEq(uint(src), uint(IOracleRouter.PriceSrc.UsdSplit));
